# 0 "C:/Users/kiera/Documents/GitHub/cosmic-construction/src/game/Item.cpp"
# 1 "C:\\Users\\kiera\\Documents\\GitHub\\cosmic-construction\\out\\build\\Test//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:/Users/kiera/Documents/GitHub/cosmic-construction/src/game/Item.cpp"
...
# 2 "C:/Users/kiera/Documents/GitHub/cosmic-construction/src/game/Item.cpp" 2
...
# 3 "C:/Users/kiera/Documents/GitHub/cosmic-construction/src/game/Item.cpp" 2
int CurrentItemID = 0;
Item::Item(sf::Vector2f position, int id, int typeID)
{
 ...
 hitbox->AddShape(new HitboxRect(sf::Vector2f(0.f, 0.f), sf::Vector2f(16 / 2.f, 16 / 2.f)));
 zindex = 1;
   ...
   for (int j = 0; j < 16; j++)
   {
    ...
    if (pixel.a == 0)
    {
     if (startPos != -1)
     {
      ...
      rect->position -= sf::Vector2f(16 / 2.f, 16 / 2.f);
